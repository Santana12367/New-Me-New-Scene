...
The 2025 recap shows the main highlights like “School,” “Friends,” “Coding,” and “Growth.” It also shows lessons I learned from a file, using small bullet points, with a light blue background and a bold title.

## Description of 2026 goals

The 2026 goals scene shows my motivations like “Focus,” “Discipline,” and “Confidence,” and lists goals from a file. It has a lavender background, a bold title, and shows my main motivation at the bottom.
## Scene API Usage

I used the Scene API to add colored backgrounds, display text, draw bullet points, and pause the scene so viewers can see it. These methods let me combine text, shapes, and colors to make the scenes look nice and organized.
